    ...
    <div className="bg-white rounded-lg border border-gray-200 p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600 text-sm">
          Help other users by sharing your experience with this service
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {renderStarRating(
            ...
            'Optional - Responsiveness and clarity'
          )}
          {renderStarRating(
            'Quality of Work',
            'quality',
            reviewData.quality || 0,
            'Optional - Meets expectations'
          )}
          {renderStarRating(
            'Delivery',
            'delivery',
            reviewData.delivery || 0,
            'Optional - Timeliness and delivery'
          )}
          {renderStarRating(
            'Value',
            'value',
            reviewData.value || 0,
            'Optional - Worth the price'
          )}
        </div>
